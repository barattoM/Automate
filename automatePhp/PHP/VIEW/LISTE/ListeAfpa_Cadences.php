...
echo '<div class="caseListe grid-columns-span-5">Liste des Afpa_Cadences </div>';
...
echo '<div class="caseListe">NbProduit</div>';
echo '<div class="caseListe">DateCadence</div>';
...
{
echo '<div class="caseListe">'.$unObjet->getNbProduit().'</div>';
echo '<div class="caseListe">'.$unObjet->getDateCadence().'</div>';
