...
echo '<div class="caseListe grid-columns-span-5">Liste des Afpa_Sons </div>';
...
echo '<div class="caseListe">ValeurSon</div>';
echo '<div class="caseListe">DateSon</div>';
...
{
echo '<div class="caseListe">'.$unObjet->getValeurSon().'</div>';
echo '<div class="caseListe">'.$unObjet->getDateSon().'</div>';
