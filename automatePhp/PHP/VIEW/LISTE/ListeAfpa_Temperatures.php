...
echo '<div class="caseListe grid-columns-span-5">Liste des Afpa_Temperatures </div>';
...
echo '<div class="caseListe">ValeurTemperature</div>';
echo '<div class="caseListe">DateTemperature</div>';
...
{
echo '<div class="caseListe">'.$unObjet->getValeurTemperature().'</div>';
echo '<div class="caseListe">'.$unObjet->getDateTemperature().'</div>';
