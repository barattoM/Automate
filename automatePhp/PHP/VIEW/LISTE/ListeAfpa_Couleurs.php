...
echo '<div class="caseListe grid-columns-span-6">Liste des Afpa_Couleurs </div>';
...
echo '<div class="caseListe">Red</div>';
echo '<div class="caseListe">Green</div>';
echo '<div class="caseListe">Blue</div>';
...
{
echo '<div class="caseListe">'.$unObjet->getRed().'</div>';
echo '<div class="caseListe">'.$unObjet->getGreen().'</div>';
echo '<div class="caseListe">'.$unObjet->getBlue().'</div>';
