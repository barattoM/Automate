...
echo '<div class="caseListe grid-columns-span-4">Liste des Afpa_Erreurs </div>';
...
echo '<div class="caseListe">MessageErreur</div>';
...
{
echo '<div class="caseListe">'.$unObjet->getMessageErreur().'</div>';
