...
echo '<div class="caseListe grid-columns-span-5">Liste des Afpa_Lumieres </div>';
...
echo '<div class="caseListe">ValeurLumiere</div>';
echo '<div class="caseListe">DateLumiere</div>';
...
{
echo '<div class="caseListe">'.$unObjet->getValeurLumiere().'</div>';
echo '<div class="caseListe">'.$unObjet->getDateLumiere().'</div>';
