...
echo '<div class="caseListe grid-columns-span-7">Liste des Afpa_Anomalies </div>';
...
echo '<div class="caseListe">DateAnomalie</div>';
echo '<div class="caseListe">TypeAnomalie</div>';
echo '<div class="caseListe">NbDeclasses</div>';
echo '<div class="caseListe">IdErreur</div>';
...
{
echo '<div class="caseListe">'.$unObjet->getDateAnomalie().'</div>';
echo '<div class="caseListe">'.$unObjet->getTypeAnomalie().'</div>';
echo '<div class="caseListe">'.$unObjet->getNbDeclasses().'</div>';
echo '<div class="caseListe">'.$unObjet->getIdErreur().'</div>';
