...
class Afpa_Cadences 
{
	...
	{
		return is_null($this->_DateCadence)?null:$this->_DateCadence->format('Y-n-j');
	}

	public function setDateCadence(?string $DateCadence)
	{
		$this->_DateCadence=is_null($DateCadence)?null:DateTime::createFromFormat("Y-n-j",$DateCadence);
	}
