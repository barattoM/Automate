...
class Afpa_Lumieres 
{
	...
	{
		return is_null($this->_DateLumiere)?null:$this->_DateLumiere->format('Y-n-j');
	}

	public function setDateLumiere(?string $DateLumiere)
	{
		$this->_DateLumiere=is_null($DateLumiere)?null:DateTime::createFromFormat("Y-n-j",$DateLumiere);
	}
