...
class Afpa_Temperatures 
{
	...
	{
		return is_null($this->_DateTemperature)?null:$this->_DateTemperature->format('Y-n-j');
	}

	public function setDateTemperature(?string $DateTemperature)
	{
		$this->_DateTemperature=is_null($DateTemperature)?null:DateTime::createFromFormat("Y-n-j",$DateTemperature);
	}
