...
class Afpa_Anomalies 
{
	...
	{
		return is_null($this->_DateAnomalie)?null:$this->_DateAnomalie->format('Y-n-j');
	}

	public function setDateAnomalie(?string $DateAnomalie)
	{
		$this->_DateAnomalie=is_null($DateAnomalie)?null:DateTime::createFromFormat("Y-n-j",$DateAnomalie);
	}
